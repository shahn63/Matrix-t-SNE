...
Score0<-Matrix_tsne(X1,X2, alpha=0, k=2,perplexity1=5,perplexity2=5)
...
Score1<-Matrix_tsne(X1,X2, alpha=1, k=2,perplexity1=5,perplexity2=5)
...
plot(c(Score[,,1]),c(Score[,,2]),col=grp1,cex=0.9, pch=grp1,lwd=1,
     main="Genes (alpha=1)",xlab="Score 1",ylab="Score 2")


# Visualization with selected alpha=0.83

Score83<-Matrix_tsne(X1,X2, alpha=0.83, k=2,perplexity1=5,perplexity2=5)
